...
**49 test files, 705 tests — all passing:**
...
| `src/pages/MatchSummary.test.jsx` *(new)* | **Nickname guard** — batsman and bowler primary `.name` shown in SCORECARD tab, never `.nickname`, even when both are set on the player and delivery objects; **injury/sub tags** — "Injured" + "Sub in for X" shown in SCORECARD tab (batting + bowling rows), no tag for a normal player |
