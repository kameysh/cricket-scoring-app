...
import { Plus, Trash2, Users2, ChevronDown, ChevronUp, X, UserPlus } from 'lucide-react';
              ...
              <div key={t.id} className="card overflow-hidden">
                ...
                <div className="p-3 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="ml-2 p-2 rounded-lg text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10"
