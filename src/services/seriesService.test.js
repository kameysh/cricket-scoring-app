      ...
      mockFrom.mockImplementation(table => {
        ...
        chain.then = (res, rej) => {
          ...
          if (t.table === 'tournaments') {
            ...
            result = {
              data: [
                { player_id: 'p1', players: { id: 'p1', name: 'Kamesh' }, bat_runs: 40, bat_innings: 2, bat_not_outs: 0, bat_balls: 50, bat_fours: 5, bat_sixes: 1, bat_fifties: 0, bat_hundreds: 0, bat_thirties: 1, bat_highest_score: 25, bowl_wickets: 2, bowl_runs: 30, bowl_legal_balls: 18, bowl_maidens: 1, bowl_five_wicket_hauls: 0, field_catches: 1, field_stumpings: 0, field_run_outs: 0, bat_matches: 1 },
