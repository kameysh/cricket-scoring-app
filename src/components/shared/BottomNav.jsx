...
import { Home, Users, Users2, Swords, Trophy, BarChart2, LogIn, LogOut, Shield, MapPin, ChevronRight, Repeat2, Sun, Moon, Monitor, Gavel, Megaphone } from 'lucide-react';
          ...
          >
            ...
            {role === 'admin' && (
              <>
                ...
                <button
                  onClick={() => { setShowSheet(false); navigate('/tournament-promo'); }}
                  className="w-full flex items-center justify-between py-3 px-1 border-t border-ink-100 dark:border-white/10 text-sm font-medium text-ink-700 dark:text-ink-200"
                >
                  <span className="flex items-center gap-2"><Megaphone size={16} /> Tournament Promo</span>
                  <ChevronRight size={16} className="text-ink-400" />
                </button>
                <button
